...
class _MapPage extends State<MapPage>{
  ...
  String authKey = 'wJDEJMVzM5Cv6hxQIbakqPvpXcE5GVmNaUvTvxKIsmrGiZar1LfdR%2Bi06o5ENa9%2FWwftxTwx1toBJr4FEFLohQ%3D%3D';
  ...
  async {
    var url = 'http://api.visitkorea.or.kr/openapi/service/rest/KorService/'
        'areaBasedList?ServiceKey=$authKey&MobileOS=AND&IOS&MobileApp=ModuTour&'
  ...
  void insertTour(Future<Database> db, TourData info) async{
    ...
    await database.insert('place', info.toMap(),
